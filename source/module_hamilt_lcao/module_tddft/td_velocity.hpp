#ifndef TD_VELOCITY_HPP
#define TD_VELOCITY_HPP
...
void TD_Velocity::folding_HR_td(const hamilt::HContainer<TR>& hR,
...
template<typename TR>
void TD_Velocity::folding_partial_HR_td(const hamilt::HContainer<TR>& hR,
                std::complex<double>* hk,
                const ModuleBase::Vector3<double>& kvec_d_in,
                const int ix,
                const int ncol,
