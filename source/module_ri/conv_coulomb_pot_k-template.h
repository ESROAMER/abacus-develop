                                   ...
                                   const K_Vectors& kv)
{
    ...
    for (size_t i = 0; i != orbs.size(); ++i)
        orbs_ccp[i] = cal_orbs_ccp(orbs[i], ccp_type, parameter, rmesh_times, kv);
    return orbs_ccp;
}

extern template Numerical_Orbital_Lm Conv_Coulomb_Pot_K::cal_orbs_ccp<Numerical_Orbital_Lm>(
...
extern template double Conv_Coulomb_Pot_K::get_rmesh_proportion(const Numerical_Orbital_Lm& orbs,
